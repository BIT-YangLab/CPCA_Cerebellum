...
from utils.utils_cortex_subjs import load_data_and_stack, write_to_cifti, \
write_to_gifti
...
def run_main(n_comps, n_sub, global_signal, rotate, 
    ...
    '''
    analysis_str = f'results_cortex/cpca_cortex_{indi}'
...
def write_results(input_type, pca_output, rotate, shuffle_ts, simulate_var, comp_weights, 
    ...
    if pca_type == 'complex':
        ...
        comp_weights_cere[:, :64984] = comp_weights
        if input_type == 'cifti':
