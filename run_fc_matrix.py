...
def run_main(n_sub, global_signal, input_type, parcellation, dynamic_fc, rest, path):
    ...
    group_data, hdr, zero_mask, cifti_obj = load_data_and_stack(n_sub, input_type, path, 0)
    ...
    write_results(fc_mat, global_signal, f'FC/fc_matrix_{path}')
...
if __name__ == '__main__':
    ...
    run_main(args_dict['n_sub'], args_dict['gs_regress'],
             ...
             args_dict['dynamic_fc'], args_dict['rest'], 
             args_dict['path'])
